# Contribution to Tailwind Colorgen
...
- [Contributing to Tailwind Colorgen 🪡](#contributing-to-tailwind-colorgen)
...
You can start with available list of [issues](https://github.com/Sanchitbajaj02/tailwind-colorgen/issues)

## I Want To Contribute

- Always check for [existing issues](https://github.com/Sanchitbajaj02/tailwind-colorgen/issues) before creating a new issue.
...
This will send a request to the maintainer to add your contribution to the main repository i.e., `https://github.com/Sanchitbajaj02/tailwind-colorgen.git`
...
Congratulations! 🎉🌟 Sit and relax, you've made your contribution to the Tailwind Colorgen project. Wait until the PR is reviewed and incorporate changes suggested by the reviewers. After which the PR can be successfully merged.
